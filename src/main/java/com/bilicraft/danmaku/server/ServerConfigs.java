...
public class ServerConfigs {
    ...
    public static final String allowedMode = "0;1;2";
    ...
    public static final boolean showSenderNameOnComment = true;

    private static final Set<Integer> sModes = Sets.newHashSet();
